...
expert:-
 ...
 User_Question=dlg_GetStr("Экспертная система","Введите вопрос системе","Какие есть заболевания на основе фотоплетизмограммы?"),%Введите вопрос системе","Каков диагноз?
...
showAllAnswers_in([H|L]):-
 ...
 dialog_yh(Str,"Beacause answer = how?"),
 showAllAnswers_in(L).
goAll("Какие есть заболевания на основе фотоплетизмограммы?",[Yes],LisrDers):-
 goAll_in("Какие есть заболевания на основе фотоплетизмограммы?",Yes,LisrDers),
 !.
